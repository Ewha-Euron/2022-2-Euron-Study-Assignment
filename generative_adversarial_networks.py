...
Original file is located at
    https://colab.research.google.com/drive/17sb8wUa700qCGKKPCJAA9OU0k4w7BVby
"""
...
### Your answer: 
no.분류기가 좋은 샘플을 생성한다고 생각하기 때문에 생성기 손실이 감소하지만 판별기는 실제로 잘 분류할 수 없으므로 매개 변수 조정이나 네트워크 재구성 필요.
"""
