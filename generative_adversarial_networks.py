...
Original file is located at
    https://colab.research.google.com/drive/18L-s9XygMsxRiXsRaNe0nSjBIUs4mKA1
"""
...
$\min_x\max_y f(x,y)$ evaluates to the value of the function at the first values of x and y.
...
No, we won't reach the optimal value.

Because, the possible value sets form a loop, one will go through this loop infinitely.
...
[Ref](https://github.com/chriskhanhtran/CS231n-CV/blob/master/assignment3/Generative_Adversarial_Networks_PyTorch.ipynb)

This is not a good sign. That the generator loss decreases means the generator is getting better at fooling the discriminator. However, the discriminor loss staying at a constant high value shows that the discriminator is not improving. If the discriminator is too easy to fool, the generator will not produce high-quality fake images.
"""
