...
def negSamplingLossAndGradient(
    ...
    out_vector = outsideVectors[outsideWordIdx]
    neg_vector = outsideVectors[negSampleWordIndices]
    
    value_outside  = out_vector.dot(centerWordVec) 
    ...
    gradCenterVec = (p_outside - 1) * out_vector + np.sum((1 - p_negative)[:, np.newaxis] * neg_vector, axis = 0)
