...
Original file is located at
    https://colab.research.google.com/drive/1AsZ8tfL3-FlsHwVKdK2nS69WZfEK-uCv
"""
...
FOLDERNAME = 'Colab Notebooks/euron/cs231n/assignment2'
...
## Answer:
두번째 플롯은 vanishing gradient 문제가 있다. batchnorm 모델이 weight init에 덜 민감한 것을 확인할 수 있다. 
첫번째 플롯은 두번째 플롯과 거의 유사하지만, overfitting problem이 있음을 찾을 수 있다. 
세번째 플롯은 exploding gradient 문제가 있다.
...
## Answer:
batch size가 normalization에 직접적힌 영향을 미친다. 배치의 통계를 계산할 때 근사치값을 찾으려 하기 때문에 발생하는 문제이다.
...
## Answer:
2
less features는 정규화 단계를 부정확하게 한다. 
"""