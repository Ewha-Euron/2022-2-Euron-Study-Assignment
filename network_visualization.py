...
Original file is located at
    https://colab.research.google.com/drive/1s1JXnbHXKuLLspacjTeitWjj6o27nOnj
"""
...
A friend of yours suggests that in order to find an image that maximizes the correct score, 
we can perform gradient ascent on the input image, 
but instead of the gradient we can actually use the saliency map in each step to update the image. Is this assertion true? Why or why not?
