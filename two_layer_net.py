...
Original file is located at
    https://colab.research.google.com/drive/1olcXN7-omlC7h83DFLYY2dcziZTqwurP
"""
...
## Answer:
1, 2
- sigmoid : x가 1또는 0에 가까워질 경우 gradient가 0이 된다.
- ReLU : x가 0보다 작을 경우 gradient가 0이 된다.
...
- 1 : 데이터가 많을수록 특정 입력 값의 weight를 더 잘 학습.
- 2 : 이 경우에 모델이 training data에서 더 작은 pattern을 학습할 수 있기 때문에 overfitting을 해결할 수 없다.
- 3 : 특정 weight가 특정 feature에 너무 큰 영향을 미치지 않게 됨.
