...
Original file is located at
    https://colab.research.google.com/drive/1xXtypYmKzDHTgYOPEvFGZBWwTfIcXM9-
"""
...
!pip install cs231n.classifiers.linear_svm
...
$\color{blue}{\textit Your Answer:}$ discrepancy는 loss function이 어떤 점에서 미분이 불가능할 때 일어난다.   
...
$\color{blue}{\textit Your Answer:}$ 해당 객체가 평균적으로 보이는 모양이다. score는 샘플과 가중치의 내적이기 때문에 더 높은 점수를 얻으려면 가중치와 샘플이 평행해야 한다.  
